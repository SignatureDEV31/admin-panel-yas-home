...
export const PropertyDialog: React.FC<PropertyDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      <div className="relative w-full max-w-[650px] bg-card border border-foreground/10 rounded-xl shadow-2xl flex flex-col z-10 transition-all duration-300 animate-in fade-in zoom-in-95 my-8">
        <button
          onClick={onClose}
